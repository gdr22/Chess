...
public class Board {
   ...
   public boolean turn; //This is a new addition, only used by the Net class
   public int aiLevel; //Used to communicate recursion level with clients
   ...
   public Board copy() {
      ...
      for(int y = 0; y < 8; y++) {
         for(int x = 0; x < 8; x++) {
            cloneBoard.board[x][y] = new Piece(board[x][y]);
         }
      }
