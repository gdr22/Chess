...
public class Move {
   ...
   /** Converts an ArrayList of moves to a String array */
   public static String[] toStringArray(List<Move> moves) {
      String[] output = new String[moves.size()];
      
      for(int i = 0; i < output.length; i++) {
         Move move = moves.get(i);
         
         output[i] = "";
         output[i] += (char)(move.ax+'a');
         output[i] += (char)(move.ay+'1');
         output[i] += (char)(move.bx+'a');
         output[i] += (char)(move.by+'1');
      }
